...
%     end
% 	N_w=floor((ite_count-ite_input_count)/16);
% 	%u = 63 - (ite_count-N_depth*16) + ite_input_count;
%     u_w = (ite_count-N_w*16) - ite_input_count;        %begin from 1 to 16
% %CA_register    
